...
type MyRecord<Key extends PropertyKey, Value> = {
    [key in Key]: Value
}
...
type Chainable<ReturnType = {}> = {
    option<
        Key extends string,
        Value
    >(key: Key extends keyof ReturnType ? never : Key, value: Value): Chainable<MyUnion<MyOmit<ReturnType, Key>, MyRecord<Key, Value>>>
    get(): ReturnType
}

type jeje = typeof result3
